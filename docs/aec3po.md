...
### The AEC3PO ontology's namespace can be accessed through the following link:
[AEC3PO NAMESPACE](https://ci.mines-stetienne.fr/aec3po/)

### The overall aim of the AEC3PO is explained in a one-minute video:
...
### The basic concepts of AECP3PO and how it operates through a number of examples can be accessed at:
...
### •	The code and pipeline for building the AEC3PO ontology can be accessed at:
